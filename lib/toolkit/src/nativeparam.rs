...
impl NativeParam {
    ...
    pub fn to_f32(&self) -> Result<f32, NativeParamError> {
        match self {
            NativeParam::Float(val) => Ok(val.to_owned()),
            _ => Err(NativeParamError::ConversionError),
        }
    }

    pub fn to_i32(&self) -> Result<i32, NativeParamError> {
        match self {
    ...
    pub fn to_string(&self) -> Result<String, NativeParamError> {
        match self {
    ...
    pub fn to_uuid(&self) -> Result<Uuid, NativeParamError> {
        match self {
    ...
    pub fn to_struct_iter(self) -> Result<IntoIter<NativeParam>, NativeParamError> {
        match self {
    ...
    pub fn to_avatar_id(self) -> Result<AvatarId, NativeParamError> {
        match self {
    ...
    pub fn to_bool(self) -> Result<bool, NativeParamError> {
        match self {
