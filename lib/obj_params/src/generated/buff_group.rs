...
pub(crate) static BUFF_GROUP_ATTRIBUTES: phf::Map<&'static str, BuffGroup> = phf_map! {
    "DisplayName" => BuffGroup::DisplayName, "SubGroups" => BuffGroup::SubGroups,
};
pub(crate) static BUFF_GROUP_ATTRIBUTES_ID: phf::Map<u16, BuffGroup> = phf_map! {
    11320u16 => BuffGroup::DisplayName, 11322u16 => BuffGroup::SubGroups,
};
impl Attribute for BuffGroup {
    fn class() -> Class {
        Class::BuffGroup
    }
...
impl AttributeInfo for BuffGroup {
    fn class(&self) -> Class {
        <Self as Attribute>::class()
    }
    fn id(&self) -> u16 {
        match self {
            Self::DisplayName => 11320u16,
            Self::SubGroups => 11322u16,
        }
    }
