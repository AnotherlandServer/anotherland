...
pub(crate) static COMPINST_COMMUNITYSRV_ATTRIBUTES: phf::Map<
    &'static str,
    CompinstCommunitysrv,
> = phf_map! {
    "BytesReceivedPeer" => CompinstCommunitysrv::BytesReceivedPeer, "BytesReceivedServer"
    => CompinstCommunitysrv::BytesReceivedServer, "BytesSentPeer" =>
    CompinstCommunitysrv::BytesSentPeer, "BytesSentServer" =>
    CompinstCommunitysrv::BytesSentServer, "cpuUsage" => CompinstCommunitysrv::CpuUsage,
    "Freq" => CompinstCommunitysrv::Freq, "gameDLL" => CompinstCommunitysrv::GameDll,
    "memoryUsage" => CompinstCommunitysrv::MemoryUsage, "memoryUsagePeak" =>
    CompinstCommunitysrv::MemoryUsagePeak, "pageFaults" =>
    CompinstCommunitysrv::PageFaults, "pageFileUsage" =>
    CompinstCommunitysrv::PageFileUsage, "pageFileUsagePeak" =>
    CompinstCommunitysrv::PageFileUsagePeak, "Power" => CompinstCommunitysrv::Power,
    "tickTime" => CompinstCommunitysrv::TickTime, "totalCPUTime" =>
    CompinstCommunitysrv::TotalCpuTime, "totalUpTime" =>
    CompinstCommunitysrv::TotalUpTime,
};
pub(crate) static COMPINST_COMMUNITYSRV_ATTRIBUTES_ID: phf::Map<
    u16,
    CompinstCommunitysrv,
> = phf_map! {
    121u16 => CompinstCommunitysrv::BytesReceivedPeer, 122u16 =>
    CompinstCommunitysrv::BytesReceivedServer, 123u16 =>
    CompinstCommunitysrv::BytesSentPeer, 124u16 => CompinstCommunitysrv::BytesSentServer,
    125u16 => CompinstCommunitysrv::CpuUsage, 135u16 => CompinstCommunitysrv::Freq,
    126u16 => CompinstCommunitysrv::GameDll, 127u16 => CompinstCommunitysrv::MemoryUsage,
    128u16 => CompinstCommunitysrv::MemoryUsagePeak, 129u16 =>
    CompinstCommunitysrv::PageFaults, 130u16 => CompinstCommunitysrv::PageFileUsage,
    131u16 => CompinstCommunitysrv::PageFileUsagePeak, 134u16 =>
    CompinstCommunitysrv::Power, 120u16 => CompinstCommunitysrv::TickTime, 132u16 =>
    CompinstCommunitysrv::TotalCpuTime, 133u16 => CompinstCommunitysrv::TotalUpTime,
};
impl Attribute for CompinstCommunitysrv {
    fn class() -> Class {
...
impl AttributeInfo for CompinstCommunitysrv {
    fn class(&self) -> Class {
        <Self as Attribute>::class()
    }
    fn id(&self) -> u16 {
        match self {
            Self::BytesReceivedPeer => 121u16,
            Self::BytesReceivedServer => 122u16,
            Self::BytesSentPeer => 123u16,
            Self::BytesSentServer => 124u16,
            Self::CpuUsage => 125u16,
            Self::Freq => 135u16,
            Self::GameDll => 126u16,
            Self::MemoryUsage => 127u16,
            Self::MemoryUsagePeak => 128u16,
            Self::PageFaults => 129u16,
            Self::PageFileUsage => 130u16,
            Self::PageFileUsagePeak => 131u16,
            Self::Power => 134u16,
            Self::TickTime => 120u16,
            Self::TotalCpuTime => 132u16,
            Self::TotalUpTime => 133u16,
        }
    }
...
impl FromStr for CompinstCommunitysrv {
    type Err = ParamError;
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        COMPINST_COMMUNITYSRV_ATTRIBUTES
            .get(s)
            .copied()
            .ok_or(ParamError::UnknownAttributeName)
    }
}
impl TryFrom<u16> for CompinstCommunitysrv {
    type Error = ParamError;
    fn try_from(val: u16) -> Result<Self, Self::Error> {
        match val {
            121u16 => Ok(Self::BytesReceivedPeer),
            122u16 => Ok(Self::BytesReceivedServer),
            123u16 => Ok(Self::BytesSentPeer),
            124u16 => Ok(Self::BytesSentServer),
            125u16 => Ok(Self::CpuUsage),
            135u16 => Ok(Self::Freq),
            126u16 => Ok(Self::GameDll),
            127u16 => Ok(Self::MemoryUsage),
            128u16 => Ok(Self::MemoryUsagePeak),
            129u16 => Ok(Self::PageFaults),
            130u16 => Ok(Self::PageFileUsage),
            131u16 => Ok(Self::PageFileUsagePeak),
            134u16 => Ok(Self::Power),
            120u16 => Ok(Self::TickTime),
            132u16 => Ok(Self::TotalCpuTime),
            133u16 => Ok(Self::TotalUpTime),
