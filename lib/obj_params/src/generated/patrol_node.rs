...
pub(crate) static PATROL_NODE_ATTRIBUTES: phf::Map<&'static str, PatrolNode> = phf_map! {
    "action0" => PatrolNode::Action0, "action0Duration" => PatrolNode::Action0Duration,
    "action0Option" => PatrolNode::Action0Option, "alwaysVisibleToPlayers" =>
    PatrolNode::AlwaysVisibleToPlayers, "autoReviveDelay" => PatrolNode::AutoReviveDelay,
    "autoReviveTime" => PatrolNode::AutoReviveTime, "AwareRange" =>
    PatrolNode::AwareRange, "BeaconRadius" => PatrolNode::BeaconRadius, "collisionExtent"
    => PatrolNode::CollisionExtent, "ContentClass" => PatrolNode::ContentClass,
    "CycleQuestBase" => PatrolNode::CycleQuestBase, "defaultWeapon" =>
    PatrolNode::DefaultWeapon, "despawnDelay" => PatrolNode::DespawnDelay, "Dialogs" =>
    PatrolNode::Dialogs, "DisplayName" => PatrolNode::DisplayName, "EnableInGame" =>
    PatrolNode::EnableInGame, "FreedomProperties" => PatrolNode::FreedomProperties,
    "Freq" => PatrolNode::Freq, "generateInterestList" =>
    PatrolNode::GenerateInterestList, "hiddenFromClients" =>
    PatrolNode::HiddenFromClients, "hiddenFromPlayers" => PatrolNode::HiddenFromPlayers,
    "HideAfterInteraction" => PatrolNode::HideAfterInteraction, "Icon" =>
    PatrolNode::Icon, "instanceTags" => PatrolNode::InstanceTags, "instanceZoneKey" =>
    PatrolNode::InstanceZoneKey, "InteractionDuration" =>
    PatrolNode::InteractionDuration, "InteractionRadius" =>
    PatrolNode::InteractionRadius, "InteractionResetTimer" =>
    PatrolNode::InteractionResetTimer, "isNonSpawnedAvatar" =>
    PatrolNode::IsNonSpawnedAvatar, "isSelfRevivable" => PatrolNode::IsSelfRevivable,
    "LastInteractionTime" => PatrolNode::LastInteractionTime, "LuaScript" =>
    PatrolNode::LuaScript, "lvl" => PatrolNode::Lvl, "MaterialOverride" =>
    PatrolNode::MaterialOverride, "nodelink" => PatrolNode::Nodelink, "originalNodeName"
    => PatrolNode::OriginalNodeName, "originalZoneName" => PatrolNode::OriginalZoneName,
    "partyGUID" => PatrolNode::PartyGuid, "pathfindSafeSpawn" =>
    PatrolNode::PathfindSafeSpawn, "pos" => PatrolNode::Pos, "Power" =>
    PatrolNode::Power, "priority" => PatrolNode::Priority, "QuestFlags" =>
    PatrolNode::QuestFlags, "ReadableName" => PatrolNode::ReadableName, "respawnDelay" =>
    PatrolNode::RespawnDelay, "RespawnRegionName" => PatrolNode::RespawnRegionName,
    "RespawnRegionNameOverride" => PatrolNode::RespawnRegionNameOverride, "rot" =>
    PatrolNode::Rot, "selfRadius" => PatrolNode::SelfRadius, "spawnMethod" =>
    PatrolNode::SpawnMethod, "spawnPosition" => PatrolNode::SpawnPosition,
    "spawnRotation" => PatrolNode::SpawnRotation, "tags" => PatrolNode::Tags, "teamID" =>
    PatrolNode::TeamId, "UE3ClassID" => PatrolNode::Ue3ClassId, "UE3EdVisual" =>
    PatrolNode::Ue3EdVisual, "VisibleOnQuestAvailable" =>
    PatrolNode::VisibleOnQuestAvailable, "VisibleOnQuestComplete" =>
    PatrolNode::VisibleOnQuestComplete, "VisibleOnQuestFinished" =>
    PatrolNode::VisibleOnQuestFinished, "VisibleOnQuestInProgress" =>
    PatrolNode::VisibleOnQuestInProgress, "WorldZoneObjectIndex" =>
    PatrolNode::WorldZoneObjectIndex, "zone" => PatrolNode::Zone, "ZoneGuid" =>
    PatrolNode::ZoneGuid, "awareDist" => PatrolNode::AwareDist, "defb" =>
    PatrolNode::Defb, "instanceGroup" => PatrolNode::InstanceGroup, "isUnAttackable" =>
    PatrolNode::IsUnAttackable, "abilities" => PatrolNode::Abilities, "alive" =>
    PatrolNode::Alive, "attackedBy" => PatrolNode::AttackedBy, "carrierGuid" =>
    PatrolNode::CarrierGuid, "clientLoadingPriority" =>
    PatrolNode::ClientLoadingPriority, "directorTags" => PatrolNode::DirectorTags,
    "forceSpawnOnClient" => PatrolNode::ForceSpawnOnClient, "hpCur" => PatrolNode::HpCur,
    "hpMax" => PatrolNode::HpMax, "isLocked" => PatrolNode::IsLocked, "spawnerAvatarGuid"
    => PatrolNode::SpawnerAvatarGuid, "spawnerAvatarID" => PatrolNode::SpawnerAvatarId,
};
pub(crate) static PATROL_NODE_ATTRIBUTES_ID: phf::Map<u16, PatrolNode> = phf_map! {
    2461u16 => PatrolNode::Action0, 2460u16 => PatrolNode::Action0Duration, 2471u16 =>
    PatrolNode::Action0Option, 3516u16 => PatrolNode::AlwaysVisibleToPlayers, 10549u16 =>
    PatrolNode::AutoReviveDelay, 10489u16 => PatrolNode::AutoReviveTime, 8268u16 =>
    PatrolNode::AwareRange, 10960u16 => PatrolNode::BeaconRadius, 2459u16 =>
    PatrolNode::CollisionExtent, 2463u16 => PatrolNode::ContentClass, 11046u16 =>
    PatrolNode::CycleQuestBase, 7235u16 => PatrolNode::DefaultWeapon, 9659u16 =>
    PatrolNode::DespawnDelay, 8855u16 => PatrolNode::Dialogs, 6621u16 =>
    PatrolNode::DisplayName, 6847u16 => PatrolNode::EnableInGame, 11170u16 =>
    PatrolNode::FreedomProperties, 2446u16 => PatrolNode::Freq, 2458u16 =>
    PatrolNode::GenerateInterestList, 2457u16 => PatrolNode::HiddenFromClients, 2444u16
    => PatrolNode::HiddenFromPlayers, 9123u16 => PatrolNode::HideAfterInteraction,
    4375u16 => PatrolNode::Icon, 2470u16 => PatrolNode::InstanceTags, 5584u16 =>
    PatrolNode::InstanceZoneKey, 11116u16 => PatrolNode::InteractionDuration, 7496u16 =>
    PatrolNode::InteractionRadius, 9125u16 => PatrolNode::InteractionResetTimer, 2433u16
    => PatrolNode::IsNonSpawnedAvatar, 7180u16 => PatrolNode::IsSelfRevivable, 9124u16 =>
    PatrolNode::LastInteractionTime, 7803u16 => PatrolNode::LuaScript, 6204u16 =>
    PatrolNode::Lvl, 4754u16 => PatrolNode::MaterialOverride, 2472u16 =>
    PatrolNode::Nodelink, 2435u16 => PatrolNode::OriginalNodeName, 2436u16 =>
    PatrolNode::OriginalZoneName, 2456u16 => PatrolNode::PartyGuid, 2443u16 =>
    PatrolNode::PathfindSafeSpawn, 2455u16 => PatrolNode::Pos, 2447u16 =>
    PatrolNode::Power, 2454u16 => PatrolNode::Priority, 9957u16 =>
    PatrolNode::QuestFlags, 3700u16 => PatrolNode::ReadableName, 2432u16 =>
    PatrolNode::RespawnDelay, 10807u16 => PatrolNode::RespawnRegionName, 10866u16 =>
    PatrolNode::RespawnRegionNameOverride, 2453u16 => PatrolNode::Rot, 2452u16 =>
    PatrolNode::SelfRadius, 6122u16 => PatrolNode::SpawnMethod, 7858u16 =>
    PatrolNode::SpawnPosition, 8211u16 => PatrolNode::SpawnRotation, 2451u16 =>
    PatrolNode::Tags, 2450u16 => PatrolNode::TeamId, 2462u16 => PatrolNode::Ue3ClassId,
    9833u16 => PatrolNode::Ue3EdVisual, 8686u16 => PatrolNode::VisibleOnQuestAvailable,
    8683u16 => PatrolNode::VisibleOnQuestComplete, 8684u16 =>
    PatrolNode::VisibleOnQuestFinished, 8685u16 => PatrolNode::VisibleOnQuestInProgress,
    2434u16 => PatrolNode::WorldZoneObjectIndex, 2448u16 => PatrolNode::Zone, 2441u16 =>
    PatrolNode::ZoneGuid, 2438u16 => PatrolNode::AwareDist, 2465u16 => PatrolNode::Defb,
    11367u16 => PatrolNode::InstanceGroup, 12430u16 => PatrolNode::IsUnAttackable,
    9328u16 => PatrolNode::Abilities, 2469u16 => PatrolNode::Alive, 2468u16 =>
    PatrolNode::AttackedBy, 2440u16 => PatrolNode::CarrierGuid, 11269u16 =>
    PatrolNode::ClientLoadingPriority, 8085u16 => PatrolNode::DirectorTags, 2439u16 =>
    PatrolNode::ForceSpawnOnClient, 2467u16 => PatrolNode::HpCur, 2466u16 =>
    PatrolNode::HpMax, 5480u16 => PatrolNode::IsLocked, 5965u16 =>
    PatrolNode::SpawnerAvatarGuid, 7690u16 => PatrolNode::SpawnerAvatarId,
};
impl Attribute for PatrolNode {
    fn class() -> Class {
        Class::PatrolNode
    }
...
impl AttributeInfo for PatrolNode {
    fn class(&self) -> Class {
        <Self as Attribute>::class()
    }
    fn id(&self) -> u16 {
        match self {
            Self::Action0 => 2461u16,
            Self::Action0Duration => 2460u16,
            Self::Action0Option => 2471u16,
            Self::AlwaysVisibleToPlayers => 3516u16,
            Self::AutoReviveDelay => 10549u16,
            Self::AutoReviveTime => 10489u16,
            Self::AwareRange => 8268u16,
            Self::BeaconRadius => 10960u16,
            Self::CollisionExtent => 2459u16,
            Self::ContentClass => 2463u16,
            Self::CycleQuestBase => 11046u16,
            Self::DefaultWeapon => 7235u16,
            Self::DespawnDelay => 9659u16,
            Self::Dialogs => 8855u16,
            Self::DisplayName => 6621u16,
            Self::EnableInGame => 6847u16,
            Self::FreedomProperties => 11170u16,
            Self::Freq => 2446u16,
            Self::GenerateInterestList => 2458u16,
            Self::HiddenFromClients => 2457u16,
            Self::HiddenFromPlayers => 2444u16,
            Self::HideAfterInteraction => 9123u16,
            Self::Icon => 4375u16,
            Self::InstanceTags => 2470u16,
            Self::InstanceZoneKey => 5584u16,
            Self::InteractionDuration => 11116u16,
            Self::InteractionRadius => 7496u16,
            Self::InteractionResetTimer => 9125u16,
            Self::IsNonSpawnedAvatar => 2433u16,
            Self::IsSelfRevivable => 7180u16,
            Self::LastInteractionTime => 9124u16,
            Self::LuaScript => 7803u16,
            Self::Lvl => 6204u16,
            Self::MaterialOverride => 4754u16,
            Self::Nodelink => 2472u16,
            Self::OriginalNodeName => 2435u16,
            Self::OriginalZoneName => 2436u16,
            Self::PartyGuid => 2456u16,
            Self::PathfindSafeSpawn => 2443u16,
            Self::Pos => 2455u16,
            Self::Power => 2447u16,
            Self::Priority => 2454u16,
            Self::QuestFlags => 9957u16,
            Self::ReadableName => 3700u16,
            Self::RespawnDelay => 2432u16,
            Self::RespawnRegionName => 10807u16,
            Self::RespawnRegionNameOverride => 10866u16,
            Self::Rot => 2453u16,
            Self::SelfRadius => 2452u16,
            Self::SpawnMethod => 6122u16,
            Self::SpawnPosition => 7858u16,
            Self::SpawnRotation => 8211u16,
            Self::Tags => 2451u16,
            Self::TeamId => 2450u16,
            Self::Ue3ClassId => 2462u16,
            Self::Ue3EdVisual => 9833u16,
            Self::VisibleOnQuestAvailable => 8686u16,
            Self::VisibleOnQuestComplete => 8683u16,
            Self::VisibleOnQuestFinished => 8684u16,
            Self::VisibleOnQuestInProgress => 8685u16,
            Self::WorldZoneObjectIndex => 2434u16,
            Self::Zone => 2448u16,
            Self::ZoneGuid => 2441u16,
            Self::AwareDist => 2438u16,
            Self::Defb => 2465u16,
            Self::InstanceGroup => 11367u16,
            Self::IsUnAttackable => 12430u16,
            Self::Abilities => 9328u16,
            Self::Alive => 2469u16,
            Self::AttackedBy => 2468u16,
            Self::CarrierGuid => 2440u16,
            Self::ClientLoadingPriority => 11269u16,
            Self::DirectorTags => 8085u16,
            Self::ForceSpawnOnClient => 2439u16,
            Self::HpCur => 2467u16,
            Self::HpMax => 2466u16,
            Self::IsLocked => 5480u16,
            Self::SpawnerAvatarGuid => 5965u16,
            Self::SpawnerAvatarId => 7690u16,
        }
    }
    ...
    fn default(&self) -> &'static Value {
        ...
        static UE_3_ED_VISUAL: Lazy<Value> = Lazy::new(|| Value::String(
            "AmunEditorIcons.PatrolNode".to_string(),
        ));
...
impl TryFrom<u16> for PatrolNode {
    ...
    fn try_from(val: u16) -> Result<Self, Self::Error> {
        match val {
            ...
            2471u16 => Ok(Self::Action0Option),
            3516u16 => Ok(Self::AlwaysVisibleToPlayers),
            10549u16 => Ok(Self::AutoReviveDelay),
            10489u16 => Ok(Self::AutoReviveTime),
            8268u16 => Ok(Self::AwareRange),
            10960u16 => Ok(Self::BeaconRadius),
            2459u16 => Ok(Self::CollisionExtent),
            2463u16 => Ok(Self::ContentClass),
            11046u16 => Ok(Self::CycleQuestBase),
            7235u16 => Ok(Self::DefaultWeapon),
            9659u16 => Ok(Self::DespawnDelay),
            8855u16 => Ok(Self::Dialogs),
            6621u16 => Ok(Self::DisplayName),
            6847u16 => Ok(Self::EnableInGame),
            11170u16 => Ok(Self::FreedomProperties),
            2446u16 => Ok(Self::Freq),
            2458u16 => Ok(Self::GenerateInterestList),
            2457u16 => Ok(Self::HiddenFromClients),
            2444u16 => Ok(Self::HiddenFromPlayers),
            9123u16 => Ok(Self::HideAfterInteraction),
            4375u16 => Ok(Self::Icon),
            2470u16 => Ok(Self::InstanceTags),
            5584u16 => Ok(Self::InstanceZoneKey),
            11116u16 => Ok(Self::InteractionDuration),
            7496u16 => Ok(Self::InteractionRadius),
            9125u16 => Ok(Self::InteractionResetTimer),
            2433u16 => Ok(Self::IsNonSpawnedAvatar),
            7180u16 => Ok(Self::IsSelfRevivable),
            9124u16 => Ok(Self::LastInteractionTime),
            7803u16 => Ok(Self::LuaScript),
            6204u16 => Ok(Self::Lvl),
            4754u16 => Ok(Self::MaterialOverride),
            2472u16 => Ok(Self::Nodelink),
            2435u16 => Ok(Self::OriginalNodeName),
            2436u16 => Ok(Self::OriginalZoneName),
            2456u16 => Ok(Self::PartyGuid),
            2443u16 => Ok(Self::PathfindSafeSpawn),
            2455u16 => Ok(Self::Pos),
            2447u16 => Ok(Self::Power),
            2454u16 => Ok(Self::Priority),
            9957u16 => Ok(Self::QuestFlags),
            3700u16 => Ok(Self::ReadableName),
            2432u16 => Ok(Self::RespawnDelay),
            10807u16 => Ok(Self::RespawnRegionName),
            10866u16 => Ok(Self::RespawnRegionNameOverride),
            2453u16 => Ok(Self::Rot),
            2452u16 => Ok(Self::SelfRadius),
            6122u16 => Ok(Self::SpawnMethod),
            7858u16 => Ok(Self::SpawnPosition),
            8211u16 => Ok(Self::SpawnRotation),
            2451u16 => Ok(Self::Tags),
            2450u16 => Ok(Self::TeamId),
            2462u16 => Ok(Self::Ue3ClassId),
            9833u16 => Ok(Self::Ue3EdVisual),
            8686u16 => Ok(Self::VisibleOnQuestAvailable),
            8683u16 => Ok(Self::VisibleOnQuestComplete),
            8684u16 => Ok(Self::VisibleOnQuestFinished),
            8685u16 => Ok(Self::VisibleOnQuestInProgress),
            2434u16 => Ok(Self::WorldZoneObjectIndex),
            2448u16 => Ok(Self::Zone),
            2441u16 => Ok(Self::ZoneGuid),
            2438u16 => Ok(Self::AwareDist),
            2465u16 => Ok(Self::Defb),
            11367u16 => Ok(Self::InstanceGroup),
            12430u16 => Ok(Self::IsUnAttackable),
            9328u16 => Ok(Self::Abilities),
            2469u16 => Ok(Self::Alive),
            2468u16 => Ok(Self::AttackedBy),
            2440u16 => Ok(Self::CarrierGuid),
            11269u16 => Ok(Self::ClientLoadingPriority),
            8085u16 => Ok(Self::DirectorTags),
            2439u16 => Ok(Self::ForceSpawnOnClient),
            2467u16 => Ok(Self::HpCur),
            2466u16 => Ok(Self::HpMax),
            5480u16 => Ok(Self::IsLocked),
            5965u16 => Ok(Self::SpawnerAvatarGuid),
            7690u16 => Ok(Self::SpawnerAvatarId),
