...
pub(crate) static TRIGGER_ATTRIBUTES: phf::Map<&'static str, Trigger> = phf_map! {
    "action0" => Trigger::Action0, "action0Duration" => Trigger::Action0Duration,
    "action0Option" => Trigger::Action0Option, "alwaysVisibleToPlayers" =>
    Trigger::AlwaysVisibleToPlayers, "autoReviveDelay" => Trigger::AutoReviveDelay,
    "autoReviveTime" => Trigger::AutoReviveTime, "AwareRange" => Trigger::AwareRange,
    "BeaconRadius" => Trigger::BeaconRadius, "collisionExtent" =>
    Trigger::CollisionExtent, "ContentClass" => Trigger::ContentClass, "CycleQuestBase"
    => Trigger::CycleQuestBase, "defaultWeapon" => Trigger::DefaultWeapon, "despawnDelay"
    => Trigger::DespawnDelay, "Dialogs" => Trigger::Dialogs, "DisplayName" =>
    Trigger::DisplayName, "EnableInGame" => Trigger::EnableInGame, "FreedomProperties" =>
    Trigger::FreedomProperties, "Freq" => Trigger::Freq, "generateInterestList" =>
    Trigger::GenerateInterestList, "hiddenFromClients" => Trigger::HiddenFromClients,
    "hiddenFromPlayers" => Trigger::HiddenFromPlayers, "HideAfterInteraction" =>
    Trigger::HideAfterInteraction, "Icon" => Trigger::Icon, "instanceTags" =>
    Trigger::InstanceTags, "instanceZoneKey" => Trigger::InstanceZoneKey,
    "InteractionDuration" => Trigger::InteractionDuration, "InteractionRadius" =>
    Trigger::InteractionRadius, "InteractionResetTimer" =>
    Trigger::InteractionResetTimer, "isNonSpawnedAvatar" => Trigger::IsNonSpawnedAvatar,
    "isSelfRevivable" => Trigger::IsSelfRevivable, "LastInteractionTime" =>
    Trigger::LastInteractionTime, "LuaScript" => Trigger::LuaScript, "lvl" =>
    Trigger::Lvl, "MaterialOverride" => Trigger::MaterialOverride, "nodelink" =>
    Trigger::Nodelink, "originalNodeName" => Trigger::OriginalNodeName,
    "originalZoneName" => Trigger::OriginalZoneName, "partyGUID" => Trigger::PartyGuid,
    "pathfindSafeSpawn" => Trigger::PathfindSafeSpawn, "pos" => Trigger::Pos, "Power" =>
    Trigger::Power, "priority" => Trigger::Priority, "QuestFlags" => Trigger::QuestFlags,
    "ReadableName" => Trigger::ReadableName, "respawnDelay" => Trigger::RespawnDelay,
    "RespawnRegionName" => Trigger::RespawnRegionName, "RespawnRegionNameOverride" =>
    Trigger::RespawnRegionNameOverride, "rot" => Trigger::Rot, "selfRadius" =>
    Trigger::SelfRadius, "spawnMethod" => Trigger::SpawnMethod, "spawnPosition" =>
    Trigger::SpawnPosition, "spawnRotation" => Trigger::SpawnRotation, "tags" =>
    Trigger::Tags, "teamID" => Trigger::TeamId, "UE3ClassID" => Trigger::Ue3ClassId,
    "UE3EdVisual" => Trigger::Ue3EdVisual, "VisibleOnQuestAvailable" =>
    Trigger::VisibleOnQuestAvailable, "VisibleOnQuestComplete" =>
    Trigger::VisibleOnQuestComplete, "VisibleOnQuestFinished" =>
    Trigger::VisibleOnQuestFinished, "VisibleOnQuestInProgress" =>
    Trigger::VisibleOnQuestInProgress, "WorldZoneObjectIndex" =>
    Trigger::WorldZoneObjectIndex, "zone" => Trigger::Zone, "ZoneGuid" =>
    Trigger::ZoneGuid, "awareDist" => Trigger::AwareDist, "defb" => Trigger::Defb,
    "instanceGroup" => Trigger::InstanceGroup, "isUnAttackable" =>
    Trigger::IsUnAttackable, "abilities" => Trigger::Abilities, "alive" =>
    Trigger::Alive, "attackedBy" => Trigger::AttackedBy, "carrierGuid" =>
    Trigger::CarrierGuid, "clientLoadingPriority" => Trigger::ClientLoadingPriority,
    "directorTags" => Trigger::DirectorTags, "forceSpawnOnClient" =>
    Trigger::ForceSpawnOnClient, "hpCur" => Trigger::HpCur, "hpMax" => Trigger::HpMax,
    "isLocked" => Trigger::IsLocked, "spawnerAvatarGuid" => Trigger::SpawnerAvatarGuid,
    "spawnerAvatarID" => Trigger::SpawnerAvatarId, "AreaRange" => Trigger::AreaRange,
    "Cooldown" => Trigger::Cooldown, "FinishQuestConfig" => Trigger::FinishQuestConfig,
    "jsonConfig" => Trigger::JsonConfig, "QuestTime" => Trigger::QuestTime, "Rewards" =>
    Trigger::Rewards, "triggerRadius" => Trigger::TriggerRadius, "ZoneLevel" =>
    Trigger::ZoneLevel,
};
pub(crate) static TRIGGER_ATTRIBUTES_ID: phf::Map<u16, Trigger> = phf_map! {
    2033u16 => Trigger::Action0, 2034u16 => Trigger::Action0Duration, 2023u16 =>
    Trigger::Action0Option, 3507u16 => Trigger::AlwaysVisibleToPlayers, 10539u16 =>
    Trigger::AutoReviveDelay, 10479u16 => Trigger::AutoReviveTime, 8258u16 =>
    Trigger::AwareRange, 10950u16 => Trigger::BeaconRadius, 2035u16 =>
    Trigger::CollisionExtent, 2031u16 => Trigger::ContentClass, 11036u16 =>
    Trigger::CycleQuestBase, 7225u16 => Trigger::DefaultWeapon, 9649u16 =>
    Trigger::DespawnDelay, 8845u16 => Trigger::Dialogs, 6611u16 => Trigger::DisplayName,
    6837u16 => Trigger::EnableInGame, 11160u16 => Trigger::FreedomProperties, 2048u16 =>
    Trigger::Freq, 2036u16 => Trigger::GenerateInterestList, 2037u16 =>
    Trigger::HiddenFromClients, 2021u16 => Trigger::HiddenFromPlayers, 9093u16 =>
    Trigger::HideAfterInteraction, 4365u16 => Trigger::Icon, 2024u16 =>
    Trigger::InstanceTags, 5574u16 => Trigger::InstanceZoneKey, 11106u16 =>
    Trigger::InteractionDuration, 7486u16 => Trigger::InteractionRadius, 9095u16 =>
    Trigger::InteractionResetTimer, 2010u16 => Trigger::IsNonSpawnedAvatar, 7170u16 =>
    Trigger::IsSelfRevivable, 9094u16 => Trigger::LastInteractionTime, 7793u16 =>
    Trigger::LuaScript, 6194u16 => Trigger::Lvl, 4744u16 => Trigger::MaterialOverride,
    2022u16 => Trigger::Nodelink, 2012u16 => Trigger::OriginalNodeName, 2013u16 =>
    Trigger::OriginalZoneName, 2038u16 => Trigger::PartyGuid, 2020u16 =>
    Trigger::PathfindSafeSpawn, 2039u16 => Trigger::Pos, 2047u16 => Trigger::Power,
    2040u16 => Trigger::Priority, 9947u16 => Trigger::QuestFlags, 3691u16 =>
    Trigger::ReadableName, 2009u16 => Trigger::RespawnDelay, 10797u16 =>
    Trigger::RespawnRegionName, 10856u16 => Trigger::RespawnRegionNameOverride, 2041u16
    => Trigger::Rot, 2042u16 => Trigger::SelfRadius, 6112u16 => Trigger::SpawnMethod,
    7848u16 => Trigger::SpawnPosition, 8201u16 => Trigger::SpawnRotation, 2043u16 =>
    Trigger::Tags, 2044u16 => Trigger::TeamId, 2032u16 => Trigger::Ue3ClassId, 9823u16 =>
    Trigger::Ue3EdVisual, 8646u16 => Trigger::VisibleOnQuestAvailable, 8643u16 =>
    Trigger::VisibleOnQuestComplete, 8644u16 => Trigger::VisibleOnQuestFinished, 8645u16
    => Trigger::VisibleOnQuestInProgress, 2011u16 => Trigger::WorldZoneObjectIndex,
    2046u16 => Trigger::Zone, 2018u16 => Trigger::ZoneGuid, 2015u16 =>
    Trigger::AwareDist, 2029u16 => Trigger::Defb, 11357u16 => Trigger::InstanceGroup,
    12427u16 => Trigger::IsUnAttackable, 9318u16 => Trigger::Abilities, 2025u16 =>
    Trigger::Alive, 2026u16 => Trigger::AttackedBy, 2017u16 => Trigger::CarrierGuid,
    11259u16 => Trigger::ClientLoadingPriority, 8075u16 => Trigger::DirectorTags, 2016u16
    => Trigger::ForceSpawnOnClient, 2027u16 => Trigger::HpCur, 2028u16 => Trigger::HpMax,
    5470u16 => Trigger::IsLocked, 5955u16 => Trigger::SpawnerAvatarGuid, 7680u16 =>
    Trigger::SpawnerAvatarId, 12298u16 => Trigger::AreaRange, 12300u16 =>
    Trigger::Cooldown, 12391u16 => Trigger::FinishQuestConfig, 12294u16 =>
    Trigger::JsonConfig, 12299u16 => Trigger::QuestTime, 12301u16 => Trigger::Rewards,
    2019u16 => Trigger::TriggerRadius, 12297u16 => Trigger::ZoneLevel,
};
impl Attribute for Trigger {
    fn class() -> Class {
        Class::Trigger
    }
    fn static_info(&self) -> &'static dyn AttributeInfo {
        match self {
            ...
            Self::AreaRange => &Self::AreaRange,
            Self::Cooldown => &Self::Cooldown,
            Self::FinishQuestConfig => &Self::FinishQuestConfig,
            Self::JsonConfig => &Self::JsonConfig,
            Self::QuestTime => &Self::QuestTime,
            Self::Rewards => &Self::Rewards,
            Self::TriggerRadius => &Self::TriggerRadius,
            Self::ZoneLevel => &Self::ZoneLevel,
        }
    }
}
impl AttributeInfo for Trigger {
    fn class(&self) -> Class {
        <Self as Attribute>::class()
    }
    fn id(&self) -> u16 {
        match self {
            Self::Action0 => 2033u16,
            Self::Action0Duration => 2034u16,
            Self::Action0Option => 2023u16,
            Self::AlwaysVisibleToPlayers => 3507u16,
            Self::AutoReviveDelay => 10539u16,
            Self::AutoReviveTime => 10479u16,
            Self::AwareRange => 8258u16,
            Self::BeaconRadius => 10950u16,
            Self::CollisionExtent => 2035u16,
            Self::ContentClass => 2031u16,
            Self::CycleQuestBase => 11036u16,
            Self::DefaultWeapon => 7225u16,
            Self::DespawnDelay => 9649u16,
            Self::Dialogs => 8845u16,
            Self::DisplayName => 6611u16,
            Self::EnableInGame => 6837u16,
            Self::FreedomProperties => 11160u16,
            Self::Freq => 2048u16,
            Self::GenerateInterestList => 2036u16,
            Self::HiddenFromClients => 2037u16,
            Self::HiddenFromPlayers => 2021u16,
            Self::HideAfterInteraction => 9093u16,
            Self::Icon => 4365u16,
            Self::InstanceTags => 2024u16,
            Self::InstanceZoneKey => 5574u16,
            Self::InteractionDuration => 11106u16,
            Self::InteractionRadius => 7486u16,
            Self::InteractionResetTimer => 9095u16,
            Self::IsNonSpawnedAvatar => 2010u16,
            Self::IsSelfRevivable => 7170u16,
            Self::LastInteractionTime => 9094u16,
            Self::LuaScript => 7793u16,
            Self::Lvl => 6194u16,
            Self::MaterialOverride => 4744u16,
            Self::Nodelink => 2022u16,
            Self::OriginalNodeName => 2012u16,
            Self::OriginalZoneName => 2013u16,
            Self::PartyGuid => 2038u16,
            Self::PathfindSafeSpawn => 2020u16,
            Self::Pos => 2039u16,
            Self::Power => 2047u16,
            Self::Priority => 2040u16,
            Self::QuestFlags => 9947u16,
            Self::ReadableName => 3691u16,
            Self::RespawnDelay => 2009u16,
            Self::RespawnRegionName => 10797u16,
            Self::RespawnRegionNameOverride => 10856u16,
            Self::Rot => 2041u16,
            Self::SelfRadius => 2042u16,
            Self::SpawnMethod => 6112u16,
            Self::SpawnPosition => 7848u16,
            Self::SpawnRotation => 8201u16,
            Self::Tags => 2043u16,
            Self::TeamId => 2044u16,
            Self::Ue3ClassId => 2032u16,
            Self::Ue3EdVisual => 9823u16,
            Self::VisibleOnQuestAvailable => 8646u16,
            Self::VisibleOnQuestComplete => 8643u16,
            Self::VisibleOnQuestFinished => 8644u16,
            Self::VisibleOnQuestInProgress => 8645u16,
            Self::WorldZoneObjectIndex => 2011u16,
            Self::Zone => 2046u16,
            Self::ZoneGuid => 2018u16,
            Self::AwareDist => 2015u16,
            Self::Defb => 2029u16,
            Self::InstanceGroup => 11357u16,
            Self::IsUnAttackable => 12427u16,
            Self::Abilities => 9318u16,
            Self::Alive => 2025u16,
            Self::AttackedBy => 2026u16,
            Self::CarrierGuid => 2017u16,
            Self::ClientLoadingPriority => 11259u16,
            Self::DirectorTags => 8075u16,
            Self::ForceSpawnOnClient => 2016u16,
            Self::HpCur => 2027u16,
            Self::HpMax => 2028u16,
            Self::IsLocked => 5470u16,
            Self::SpawnerAvatarGuid => 5955u16,
            Self::SpawnerAvatarId => 7680u16,
            Self::AreaRange => 12298u16,
            Self::Cooldown => 12300u16,
            Self::FinishQuestConfig => 12391u16,
            Self::JsonConfig => 12294u16,
            Self::QuestTime => 12299u16,
            Self::Rewards => 12301u16,
            Self::TriggerRadius => 2019u16,
            Self::ZoneLevel => 12297u16,
        }
    }
    fn name(&self) -> &'static str {
        match self {
            ...
            Self::FinishQuestConfig => "FinishQuestConfig",
    ...
    fn datatype(&self) -> ParamType {
        match self {
            Self::AreaRange => ParamType::Int,
            Self::Cooldown => ParamType::Int,
            Self::FinishQuestConfig => ParamType::JsonValue,
            Self::JsonConfig => ParamType::JsonValue,
            Self::QuestTime => ParamType::Int,
            Self::Rewards => ParamType::Guid,
            Self::TriggerRadius => ParamType::Float,
            Self::ZoneLevel => ParamType::Int,
    ...
    fn default(&self) -> &'static Value {
        static AREA_RANGE: Value = Value::Int(0i32);
        static COOLDOWN: Value = Value::Int(0i32);
        static FINISH_QUEST_CONFIG: Lazy<Value> = Lazy::new(|| Value::JsonValue(
            JsonValue::default(),
        ));
        static JSON_CONFIG: Lazy<Value> = Lazy::new(|| Value::JsonValue(
            JsonValue::default(),
        ));
        static QUEST_TIME: Value = Value::Int(0i32);
        static REWARDS: Value = Value::Guid(
            Uuid::from_bytes([
        ...
        static ZONE_LEVEL: Value = Value::Int(0i32);
        ...
        match self {
            Self::AreaRange => &AREA_RANGE,
            Self::Cooldown => &COOLDOWN,
            Self::FinishQuestConfig => &FINISH_QUEST_CONFIG,
            Self::JsonConfig => &JSON_CONFIG,
            Self::QuestTime => &QUEST_TIME,
            Self::Rewards => &REWARDS,
...
impl TryFrom<u16> for Trigger {
    ...
    fn try_from(val: u16) -> Result<Self, Self::Error> {
        match val {
            ...
            2023u16 => Ok(Self::Action0Option),
            3507u16 => Ok(Self::AlwaysVisibleToPlayers),
            10539u16 => Ok(Self::AutoReviveDelay),
            10479u16 => Ok(Self::AutoReviveTime),
            8258u16 => Ok(Self::AwareRange),
            10950u16 => Ok(Self::BeaconRadius),
            2035u16 => Ok(Self::CollisionExtent),
            2031u16 => Ok(Self::ContentClass),
            11036u16 => Ok(Self::CycleQuestBase),
            7225u16 => Ok(Self::DefaultWeapon),
            9649u16 => Ok(Self::DespawnDelay),
            8845u16 => Ok(Self::Dialogs),
            6611u16 => Ok(Self::DisplayName),
            6837u16 => Ok(Self::EnableInGame),
            11160u16 => Ok(Self::FreedomProperties),
            2048u16 => Ok(Self::Freq),
            2036u16 => Ok(Self::GenerateInterestList),
            2037u16 => Ok(Self::HiddenFromClients),
            2021u16 => Ok(Self::HiddenFromPlayers),
            9093u16 => Ok(Self::HideAfterInteraction),
            4365u16 => Ok(Self::Icon),
            2024u16 => Ok(Self::InstanceTags),
            5574u16 => Ok(Self::InstanceZoneKey),
            11106u16 => Ok(Self::InteractionDuration),
            7486u16 => Ok(Self::InteractionRadius),
            9095u16 => Ok(Self::InteractionResetTimer),
            2010u16 => Ok(Self::IsNonSpawnedAvatar),
            7170u16 => Ok(Self::IsSelfRevivable),
            9094u16 => Ok(Self::LastInteractionTime),
            7793u16 => Ok(Self::LuaScript),
            6194u16 => Ok(Self::Lvl),
            4744u16 => Ok(Self::MaterialOverride),
            2022u16 => Ok(Self::Nodelink),
            2012u16 => Ok(Self::OriginalNodeName),
            2013u16 => Ok(Self::OriginalZoneName),
            2038u16 => Ok(Self::PartyGuid),
            2020u16 => Ok(Self::PathfindSafeSpawn),
            2039u16 => Ok(Self::Pos),
            2047u16 => Ok(Self::Power),
            2040u16 => Ok(Self::Priority),
            9947u16 => Ok(Self::QuestFlags),
            3691u16 => Ok(Self::ReadableName),
            2009u16 => Ok(Self::RespawnDelay),
            10797u16 => Ok(Self::RespawnRegionName),
            10856u16 => Ok(Self::RespawnRegionNameOverride),
            2041u16 => Ok(Self::Rot),
            2042u16 => Ok(Self::SelfRadius),
            6112u16 => Ok(Self::SpawnMethod),
            7848u16 => Ok(Self::SpawnPosition),
            8201u16 => Ok(Self::SpawnRotation),
            2043u16 => Ok(Self::Tags),
            2044u16 => Ok(Self::TeamId),
            2032u16 => Ok(Self::Ue3ClassId),
            9823u16 => Ok(Self::Ue3EdVisual),
            8646u16 => Ok(Self::VisibleOnQuestAvailable),
            8643u16 => Ok(Self::VisibleOnQuestComplete),
            8644u16 => Ok(Self::VisibleOnQuestFinished),
            8645u16 => Ok(Self::VisibleOnQuestInProgress),
            2011u16 => Ok(Self::WorldZoneObjectIndex),
            2046u16 => Ok(Self::Zone),
            2018u16 => Ok(Self::ZoneGuid),
            2015u16 => Ok(Self::AwareDist),
            2029u16 => Ok(Self::Defb),
            11357u16 => Ok(Self::InstanceGroup),
            12427u16 => Ok(Self::IsUnAttackable),
            9318u16 => Ok(Self::Abilities),
            2025u16 => Ok(Self::Alive),
            2026u16 => Ok(Self::AttackedBy),
            2017u16 => Ok(Self::CarrierGuid),
            11259u16 => Ok(Self::ClientLoadingPriority),
            8075u16 => Ok(Self::DirectorTags),
            2016u16 => Ok(Self::ForceSpawnOnClient),
            2027u16 => Ok(Self::HpCur),
            2028u16 => Ok(Self::HpMax),
            5470u16 => Ok(Self::IsLocked),
            5955u16 => Ok(Self::SpawnerAvatarGuid),
            7680u16 => Ok(Self::SpawnerAvatarId),
            12298u16 => Ok(Self::AreaRange),
            12300u16 => Ok(Self::Cooldown),
            12391u16 => Ok(Self::FinishQuestConfig),
            12294u16 => Ok(Self::JsonConfig),
            12299u16 => Ok(Self::QuestTime),
            12301u16 => Ok(Self::Rewards),
            2019u16 => Ok(Self::TriggerRadius),
            12297u16 => Ok(Self::ZoneLevel),
