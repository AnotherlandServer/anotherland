...
use tokio::{net::ToSocketAddrs, io};
            ...
            Message::AtlasPkt(pkt) => {
                ...
                match &pkt {
                    CPkt::CPktLogin(login_pkt) => {
                        ...
                        result.realm_ip = Some(u32::from_be(Ipv4Addr::new(192, 168, 178, 45).into()));
                        ...
                        response.add_message(Reliability::Reliable, result.as_message());
                        ...
                        response.add_message(Reliability::Reliable, realm_status.as_message());
                    },
